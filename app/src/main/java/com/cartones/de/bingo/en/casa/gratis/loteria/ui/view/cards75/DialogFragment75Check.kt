...
class DialogFragment75Check(var listener: OnClickListener, val listNumbers: List<Int>): DialogFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.dialog_fragment_check_number75, container, false)
    }
